...
const Footer = () => {
  return (
    <div>
      <div className=" customw:w-[1728px] h-[388px] pt-24 pb-12 flex-col justify-start items-center gap-16  inline-flex">
    <div className="justify-center items-start gap-[100px]  inline-flex">
        <div className=" flex-col justify-center items-start customw:px-0 px-10 gap-8 inline-flex">
            <div className="justify-start items-center gap-2.5 inline-flex">
                <div className="w-[25.38px] h-7 relative">
                <img src="/Group.png" alt="logo"/>
                </div>
                <div><span className="text-gray-900 text-xl customw:text-2xl font-semibold ">ClearLink</span><span className="text-blue-500 text-2xl font-semibold font-['Inter']">.</span></div>
            </div>
            <div className="self-stretch text-slate-600 text-sm customw:text-lg font-normal  leading-7">ClearLink is your gateway to effortless, high-quality video conferencing. Join us in shaping the future of communication!</div>
        </div>
        <div className="justify-start items-start gap-8 flex">
            <div className="w-40 flex-col justify-start items-start gap-4 inline-flex">
                <div className="self-stretch text-gray-500 text-base font-semibold  leading-normal">Product</div>
            ...
            <div className="w-40 flex-col justify-start items-start gap-4 inline-flex">
                <div className="self-stretch text-gray-500 text-base font-semibold leading-normal">Resources</div>
                <div className="self-stretch h-[204px] flex-col justify-start items-start gap-4 flex">
                    <div className="justify-start items-center gap-2 inline-flex">
                        <div className="justify-center items-center gap-2 flex">
            ...
            <div className="w-40 flex-col justify-start items-start gap-4 inline-flex">
                <div className="self-stretch text-gray-500 text-base font-semibold  leading-normal">Legal</div>
                <div className="self-stretch h-[204px] flex-col justify-start items-start gap-4 flex">
                    <div className="justify-start items-center gap-2 inline-flex">
                        <div className="justify-center items-center gap-2 flex">
