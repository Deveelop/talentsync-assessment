    ...
    <div className="w-[579px] flex-col justify-start items-start gap-10 inline-flex">
            ...
            <div className="self-stretch h-[188px] pl-4 flex-col justify-start items-start gap-5 flex">
                <div className="self-stretch justify-start items-start gap-3 inline-flex">
                    ...
                    <div className="grow shrink basis-0 flex-col justify-start items-start inline-flex">
                        <div className="self-stretch text-slate-600 text-2xl font-normal font-['Inter'] leading-loose">30 days free trial</div>
                    </div>
                </div>
                <div className="self-stretch justify-start items-start gap-3 inline-flex">
                    <div className="w-7 h-7 rounded-[14px] justify-center items-center flex">
                    ...
                    <div className="grow shrink basis-0 flex-col justify-start items-start inline-flex">
                        <div className="self-stretch text-slate-600 text-2xl font-normal font-['Inter'] leading-loose">Cancel at any time</div>
                    </div>
                </div>
                <div className="self-stretch justify-start items-start gap-3 inline-flex">
                    <div className="w-7 h-7 rounded-[14px] justify-center items-center flex">
                    ...
                    <div className="grow shrink basis-0 flex-col justify-start items-start inline-flex">
                        <div className="self-stretch text-slate-600 text-2xl font-normal font-['Inter'] leading-loose">Access to all features</div>
                    </div>
                </div>
                <div className="self-stretch justify-start items-start gap-3 inline-flex">
                    <div className="w-7 h-7 rounded-[14px] justify-center items-center flex">
                    ...
                    <div className="grow shrink basis-0 flex-col justify-start items-start inline-flex">
                        <div className="self-stretch text-slate-600 text-2xl font-normal font-['Inter'] leading-loose">Peronalized onboarding</div>
                    </div>
                </div>
            </div>
        </div>
        <div className="justify-start items-center gap-2 inline-flex">
            ...
            <div className="px-6 py-3.5 bg-blue-700 rounded-[100px] shadow justify-center items-center gap-1 flex">
                <div className="text-white text-base font-semibold font-['Inter'] leading-normal">Start your free trial</div>
            </div>
        </div>
    </div>
    <div className="justify-end items-center flex">
        <div className="w-[1024px] h-[682px] rounded-xl border-8 border-gray-900 justify-center items-center inline-flex">
            <img className="w-[1024px] h-[682px] relative rounded-xl" src="https://via.placeholder.com/1024x682" />
        </div>
    </div>
</div>
    </div>
